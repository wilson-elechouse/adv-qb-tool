...
def main():
    ...
    ap.add_argument("--batch-ai-review-mode", choices=["review-worthy", "all-eligible"], default="all-eligible")
    ap.add_argument("--codex-review-mode", choices=["review-worthy", "all-eligible"], default="review-worthy")
    ap.add_argument("--require-codex-review", action="store_true")
    ...
    print(json.dumps({
        ...
        "status_hint": f"python {script_path('chunk_job_status.py')}",
        "resume_hint": f"python {script_path('resume_chunk_job.py')}",
